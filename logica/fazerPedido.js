...
function chamaNoZap() {
    ...
    if(cep) {
        window.open(`https://wa.me//557186686018?text=Olá,%20olhei%20o%20catálogo%20AZUNI%20e%20tenho%20interesse%20em:%0A%0A${produtoComprado}%0ATotal:%0AR$%20${total.toFixed(2)}.%0A%0AO%20meu%20CEP%20é:%0A${cep}.`)
    } else {
