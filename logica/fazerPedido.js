...
function chamaNoZap() {
    ...
    window.open(`https://wa.me//557186686018?text=Olá,%20olhei%20o%20catálogo%20AZUNI%20e%20tenho%20interesse%20nisso:${quebraDeLinha}${quebraDeLinha}${produtoComprado}${quebraDeLinha}${quebraDeLinha}%20o%20total%20da%20minha%20compra%20foi%20de%20R$%20${quebraDeLinha}${total.toFixed(2)}.`)
}
